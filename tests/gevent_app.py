...
Both knobs are parametrised:
    ...
    python tests/gevent_app.py                    # 50 greenlets, run forever
    python tests/gevent_app.py -c 5000            # 5000 concurrent greenlets
    python tests/gevent_app.py -c 200 -n 100000   # stop after 100k jobs
